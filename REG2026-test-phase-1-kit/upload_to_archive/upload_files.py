...
For your challenge, and this phase it is 'reg2026-test-phase-1-dataset'.
...
Check your uploaded results here:
 https://grand-challenge.org/archives/reg2026-test-phase-1-dataset/
...
ARCHIVE_SLUG = "reg2026-test-phase-1-dataset"
